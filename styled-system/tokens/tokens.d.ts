/* eslint-disable */
export type Token = "colors.base" | "colors.bgBase" | "colors.white" | "colors.primary" | "colors.secondary" | "colors.tertiary" | "colors.quaternary" | "fonts.futura" | "fontSizes.2xs" | "fontSizes.xs" | "fontSizes.sm" | "fontSizes.md" | "fontSizes.lg" | "fontSizes.xl" | "fontSizes.2xl" | "fontSizes.3xl" | "fontSizes.4xl" | "fontSizes.5xl" | "fontSizes.6xl" | "fontSizes.7xl" | "fontSizes.8xl" | "fontSizes.9xl" | "borders.primary" | "gradients.signUp" | "sizes.maxWidth" | "sizes.full" | "sizes.headerHeight" | "sizes.breakpoint-sm" | "sizes.breakpoint-md" | "sizes.breakpoint-lg" | "sizes.breakpoint-xl" | "sizes.breakpoint-2xl" | "spacing.baseX" | "spacing.baseY" | "radii.xs" | "radii.sm" | "radii.md" | "radii.lg" | "radii.xl" | "radii.2xl" | "radii.3xl" | "radii.full" | "letterSpacings.base" | "shadows.float" | "breakpoints.sm" | "breakpoints.md" | "breakpoints.lg" | "breakpoints.xl" | "breakpoints.2xl" | "spacing.-baseX" | "spacing.-baseY"

export type ColorToken = "base" | "bgBase" | "white" | "primary" | "secondary" | "tertiary" | "quaternary"
